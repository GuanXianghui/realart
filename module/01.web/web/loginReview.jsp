...
<head>
    ...
    <script type="text/javascript" src="scripts/loginReview.js"></script>
</head>
<body>
...
<div>
    <form name="loginReviewForm" action="loginReview.do" method="post">
        <input type="hidden" name="token" value="<%=token%>">
        <div align="center">评论会员登录界面</div>
        <div>账号<input type="text" id="name" name="name" value="<%=StringUtils.trimToEmpty((String)request.getAttribute("name"))%>"></div>
        <div>密码<input type="password" id="password" name="password"></div>
        <div>
            <input type="button" value="登录" onclick="loginReview()">
            <input type="button" value="注册" onclick="registReview()">
            <a href="#">忘记密码</a>
        </div>
    </form>
</div>
