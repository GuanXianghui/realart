...
<div>
    <form name="registArtistForm" method="post" autocomplete="off" action="registArtist.do?token=<%=token%>"
        ...
        <div align="center">艺术家注册界面</div>
        <div>艺术家用户名<input type="text" id="name" name="name" value="<%=StringUtils.trimToEmpty((String)request.getAttribute("name"))%>"></div>
        ...
        <div>艺术家压题图<input type="file" id="title_photo" name="titlePhoto"></div>
        ...
        <div>
            ...
            <input type="button" value="OK 提交" onclick="registArtist()">
        </div>
    </form>
</div>
