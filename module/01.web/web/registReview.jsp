        ...
        <div align="center">
            <table>
                ...
                <tr>
                    ...
                    <td class="rightTd">
                        <input class="text-input between-medium-large-input" type="text" id="cert_name" name="certName"
                               value="<%=StringUtils.trimToEmpty((String)request.getAttribute("certName"))%>">
                    </td>
                </tr>
                <tr>
                    <td class="leftTd">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <input class="button" type="button" value="OK 提交" onclick="registReview()">
                    </td>
                </tr>
            </table>
        </div>
