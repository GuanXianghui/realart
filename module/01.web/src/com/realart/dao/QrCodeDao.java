...
public class QrCodeDao {
     ...
     * @throws Exception
     */
    public static int countQrCodesByState(int state) throws Exception {
     ...
     * @throws Exception
     */
    public static List<QrCode> queryQrCodesByStateAndPayNum(int state, int pageNum) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                QrCode qrCode = new QrCode(id, uuid, imgPath, state2, artId, info, createDate, createTime, createIp);
                list.add(qrCode);
            }
            return list;
        } finally {
