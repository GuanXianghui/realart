 ...
 */
public class DeleteYsjParamAction extends BaseAction implements UserInterface{
    private String id;
    ...
    private URLTitleName getURLTitleNameById(String id) throws Exception {
        List<URLTitleName> friendSiteList = ysjScrollParamUtil.getInstance().getValueByID(HomeParamInterface.HOME_YSJ_LIST);
