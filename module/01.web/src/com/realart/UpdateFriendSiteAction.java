 ...
 */
public class UpdateFriendSiteAction extends BaseAction implements UserInterface{
    private String friendSiteCount;
    private File img1;
    private File img2;
    private File img3;
    private File img4;
    ...
    public String execute() throws Exception {
        logger.info("friendSiteCount:[" + friendSiteCount + "]");

        //总个数
        int friendSiteCountInt = Integer.parseInt(friendSiteCount);
        for(int i=0;i<friendSiteCountInt;i++){
            ...
            if(null == urlTitleName){//没有则新增
                ...
                urlTitleName = new URLTitleName(0, name, url, img, "1".equals(dis), HomeParamInterface.HOME_FRIENDSITE_LIST);
    ...
    public String getFriendSiteCount() {
        return friendSiteCount;
    }

    public void setFriendSiteCount(String friendSiteCount) {
        this.friendSiteCount = friendSiteCount;
    }
